        ...
        >
          ...
          <div className="flex justify-between items-start mb-8">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 rounded-2xl bg-[#8B5CF6] border-[3px] border-[#18181B] dark:border-white flex items-center justify-center font-black text-2xl text-white shadow-[#18181B] dark:shadow-[#FFFFFF]">
                PP
              </div>
              <div>
